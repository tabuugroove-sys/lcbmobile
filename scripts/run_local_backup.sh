...
export MIN_VISUAL_MEDIA_ASSETS="${MIN_VISUAL_MEDIA_ASSETS:-1}"
export ALLOW_SOURCE_ARTICLE_IMAGE="${ALLOW_SOURCE_ARTICLE_IMAGE:-true}"
export REQUIRE_VIDEO_MEDIA="${REQUIRE_VIDEO_MEDIA:-false}"
export MIN_VIDEO_MEDIA_ASSETS="${MIN_VIDEO_MEDIA_ASSETS:-0}"
